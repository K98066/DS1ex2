...
void Infix2Prefix(Token* exp) {
    ...
    Stack reverseExp;
    while (curPtr != NULL) {
        reverseExp.push(curPtr);
        curPtr = curPtr->next;
    }
    
    curPtr = reverseExp.getTop();
    ...
    while (curPtr != NULL) {
        if (curPtr->ope == '0' || curPtr->ope == '1' || curPtr->ope == '2' || curPtr->ope == '3' || 
            ...
            printf("%c", curPtr->ope);
            operands.push(curPtr);
        }
        else if (curPtr->ope == '(' && openPar > 0) {
            
            operators.clearStack(operators);
            openPar--;
        }
        else if ((curPtr->ope == '+' || curPtr->ope == '-') && time_divide == true) {
            
            operators.clearStack(operators);
            time_divide = false;
            operators.push(curPtr);
            if (curPtr->ope == '(') {
                openPar++;
            }
            else if (curPtr->ope == '*' || curPtr->ope == '/') {
        ...
        else if ((curPtr->ope == '+' || curPtr->ope == '-') && level == 2) {
        ...
        else if ((curPtr->ope == '*' || curPtr->ope == '/') && level == 1) {
